# TCS Windows 10 Machine Pre-Installation Preperation Tool - v0.11 - Copyright (c) 2023 Carl Hopkins
...
Start-BitsTransfer -Source "https://raw.githubusercontent.com/carlhopkins/TCS-Win10-Preinstall/main/current/hfimage.jpg" -Destination hfimage.jpg
